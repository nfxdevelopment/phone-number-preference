...
public class PhoneNumberActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button button = findViewById(R.id.switch_mode_button);
        button.setOnClickListener(this);
    }

    @Override
    public void onClick(View v) {
        Intent intent = new Intent(this, PhoneNumberActivityCompat.class);
    ...
    public static class RangeBarFragment extends PreferenceFragment
                ...
                new Preference.OnPreferenceChangeListener() {
                    ...
                    public boolean onPreferenceChange(Preference preference, Object newValue) {
                        Log.i(TAG, "onPreferenceChange called Preference Change Key : " +
                                getString(R.string.phone_number) + " value : " + newValue);
                        return true;
                    }
                };
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            addPreferencesFromResource(R.xml.preference_phone_number);
        }
        ...
        public void onResume() {
            ...
            Preference preference = getPreferenceManager().findPreference(getString(R.string.phone_number));
